...
class TestCheckOutAPIView(APIBaseTestMixin):
    def test_check_out_api_view_function_is_correct(self):
        view = resolve(
            reverse('hospedes:check_out_api', kwargs={'id': 1})
        )
        self.assertIs(view.func.view_class, api.CheckOutAPIView)

    def test_check_out_api_view_returns_code_401_if_not_authenticated(self):  # noqa: E501
        api_url = reverse('hospedes:check_out_api', kwargs={'id': 1})
    ...
    def test_check_out_api_view_will_receive_code_405_if_method_is_put(self):
        # pegando um usuario
    ...
    def test_check_out_api_view_will_receive_code_405_if_method_is_patch(self):
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
    ...
    def test_check_out_api_view_will_receive_code_405_if_method_is_delete(self):  # noqa: E501
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
    ...
    def test_check_out_api_view_will_return_404_if_not_hospede_method_get(self):  # noqa: E501
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
        ...
        api_url = reverse('hospedes:check_out_api', kwargs={'id': fake_id})
        # passando metodo delete buscando uma falha
    ...
    def test_check_out_api_view_will_return_404_if_not_hospede_method_post(self):  # noqa: E501
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
    ...
    def test_check_out_api_view_will_return_400_if_action_is_not_check_out(self):  # noqa: E501
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
        ...
        api_url = reverse(
            'hospedes:check_out_api',
            kwargs={'id': hospede.id}
        )
        # agora simular realizar checkout recebendo um action diferente de
        # check_out
        data_checkin = {
            "id": 1,
            "nome_completo": "TEST",
        ...
        self.assertEqual(
            response.data['error'],
            'Não foi possivel realizar o check-out.'
        )
        self.assertEqual(response.status_code, 400)

    def test_check_out_api_view_will_return_200_if_action_is_check_out(self):  # noqa: E501
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
        ...
        # agora simular realizar checkout recebendo o action correto
        # check_out
        data_checkin = {
            "id": 1,
            "nome_completo": "TEST",
        ...
        # checando se a msg de sucesso esta na resposta e o usuario fez
        # checkout
        self.assertEqual(
        ...
        # fazendo isso para ver se o status dele foi atualizado com sucesso
        # para checkout_realizado
        self.assertEqual(hospede.status, 'CHECKOUT_REALIZADO')

    def test_check_out_api_view_will_return_hospede_data_if_get_method(self):
        # pegando um usuario
        auth_data = self.get_auth_data()
        # pegando seu acesso com jwt token
        jwt_access = auth_data.get('jwt_access_token')
